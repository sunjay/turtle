...
mod tests {
    ...
    fn logical_coords() {
        // The origin is always at fb_center as long as center is also the origin
        let logical_coord = ScreenPoint { x: 200.0, y: 300.0 }.to_logical(
            1.0,
            Point::origin(),
            ScreenPoint { x: 200.0, y: 300.0 },
        );
        ...
        // The x-axis and y-axis treated distinctly and interpreted as cartesian
        let logical_coord = ScreenPoint { x: 210.0, y: 280.0 }.to_logical(
            1.0,
            Point::origin(),
            ScreenPoint { x: 200.0, y: 300.0 },
        );
        ...
        // A different fb_center gives a different final coordinate
        let logical_coord = ScreenPoint { x: 310.0, y: 380.0 }.to_logical(
            1.0,
            Point::origin(),
            ScreenPoint { x: 300.0, y: 400.0 },
        );
        ...
        // The center is interpreted as cartesian and points are relative to it
        let logical_coord = ScreenPoint { x: 180.0, y: 285.0 }.to_logical(
            1.0,
            Point { x: 30.0, y: 5.0 },
            ScreenPoint { x: 200.0, y: 300.0 },
        );
        ...
        // Negative points work too
        let logical_coord = ScreenPoint { x: 160.0, y: 315.0 }.to_logical(
            1.0,
            Point { x: 30.0, y: -5.0 },
            ScreenPoint { x: 200.0, y: 300.0 },
        );
        ...
        // DPI scale > 1.0 causes logical coordinates to scale, but NOT screen coordinates
        let logical_coord = ScreenPoint { x: 160.0, y: 270.0 }.to_logical(
            2.0,
            Point { x: 30.0, y: 5.0 },
            ScreenPoint { x: 200.0, y: 300.0 },
        );
