...
//!
//! This module has a wide variety of color constants. You can refer to them using their color
//! name as a string literal. For example:
//!
//! ```rust,no_run
//! # extern crate turtle;
//! # use turtle::color;
...
//! ```
//!
//! You can also use hex literals to get any color you want (even ones that aren't listed).
//!
//! ```rust,no_run
//! # extern crate turtle;
//! # fn main() {
...
//! ```
//!
//! The full list of color names supported is in the documentation for this module.
