...
use super::{
    ClientRequest, ConnectionError, DrawingProp, DrawingPropValue, ExportFormat, PenProp,
    PenPropValue, RotationDirection, ServerResponse, TurtleProp, TurtlePropValue,
};
...
impl ProtocolClient {
    ...
    pub async fn create_turtle(&self) -> TurtleId {
        ...
        match response {
            ...
            _ => unreachable!(
                "bug: expected to receive `NewTurtle` in response to `CreateTurtle` request"
            ),
        }
    }
    ...
    pub async fn export_svg(&self, path: PathBuf) -> Result<(), ExportError> {
        self.client
            .send(ClientRequest::Export(path, ExportFormat::Svg));

        let response = self.client.recv().await;
        match response {
            ServerResponse::ExportComplete(res) => res,
            _ => unreachable!(
                "bug: expected to receive `ExportComplete` in response to `Export` request"
            ),
        }
    }
    ...
    pub async fn poll_event(&self) -> Option<Event> {
        ...
        match response {
            ...
            _ => {
                unreachable!("bug: expected to receive `Event` in response to `NextEvent` request")
            }
        }
    }
    ...
    pub async fn drawing_title(&self) -> String {
        self.client
            .send(ClientRequest::DrawingProp(DrawingProp::Title));

        let response = self.client.recv().await;
        match response {
            ServerResponse::DrawingProp(DrawingPropValue::Title(value)) => value,
            _ => unreachable!(
                "bug: expected to receive `DrawingProp` in response to `DrawingProp` request"
            ),
        }
    }
    ...
    pub async fn drawing_background(&self) -> Color {
        self.client
            .send(ClientRequest::DrawingProp(DrawingProp::Background));
    ...
    pub async fn drawing_center(&self) -> Point {
        self.client
            .send(ClientRequest::DrawingProp(DrawingProp::Center));
    ...
    pub async fn drawing_size(&self) -> Size {
        self.client
            .send(ClientRequest::DrawingProp(DrawingProp::Size));
    ...
    pub async fn drawing_is_maximized(&self) -> bool {
        self.client
            .send(ClientRequest::DrawingProp(DrawingProp::IsMaximized));
    ...
    pub async fn drawing_is_fullscreen(&self) -> bool {
        self.client
            .send(ClientRequest::DrawingProp(DrawingProp::IsFullscreen));
    ...
    pub fn drawing_set_title(&self, value: String) {
        self.client
            .send(ClientRequest::SetDrawingProp(DrawingPropValue::Title(
                value,
            )))
    }
    ...
    pub fn drawing_set_background(&self, value: Color) {
        ...
        self.client
            .send(ClientRequest::SetDrawingProp(DrawingPropValue::Background(
                value,
            )))
    }
    ...
    pub fn drawing_set_center(&self, value: Point) {
        ...
        self.client
            .send(ClientRequest::SetDrawingProp(DrawingPropValue::Center(
                value,
            )))
    }
    ...
    pub fn drawing_set_size(&self, value: Size) {
        ...
        self.client
            .send(ClientRequest::SetDrawingProp(DrawingPropValue::Size(value)))
    }

    pub fn drawing_set_is_maximized(&self, value: bool) {
        self.client.send(ClientRequest::SetDrawingProp(
            DrawingPropValue::IsMaximized(value),
        ))
    }

    pub fn drawing_set_is_fullscreen(&self, value: bool) {
        self.client.send(ClientRequest::SetDrawingProp(
            DrawingPropValue::IsFullscreen(value),
        ))
    }

    pub fn drawing_reset_center(&self) {
        self.client
            .send(ClientRequest::ResetDrawingProp(DrawingProp::Center))
    }

    pub fn drawing_reset_size(&self) {
        self.client
            .send(ClientRequest::ResetDrawingProp(DrawingProp::Size))
    }

    pub async fn turtle_pen_is_enabled(&self, id: TurtleId) -> bool {
        self.client.send(ClientRequest::TurtleProp(
            id,
            TurtleProp::Pen(PenProp::IsEnabled),
        ));

        let response = self.client.recv().await;
        match response {
            ServerResponse::TurtleProp(
                recv_id,
            ...
            _ => unreachable!(
                "bug: expected to receive `TurtleProp` in response to `TurtleProp` request"
            ),
        }
    }
    ...
    pub async fn turtle_pen_thickness(&self, id: TurtleId) -> f64 {
        self.client.send(ClientRequest::TurtleProp(
            id,
            TurtleProp::Pen(PenProp::Thickness),
        ));
    ...
    pub async fn turtle_pen_color(&self, id: TurtleId) -> Color {
        ...
        match response {
            ServerResponse::TurtleProp(
                recv_id,
                TurtlePropValue::Pen(PenPropValue::Color(value)),
            ) => {
                debug_assert_eq!(id, recv_id, "bug: received data for incorrect turtle");
                value
            }
    ...
    pub async fn turtle_fill_color(&self, id: TurtleId) -> Color {
        self.client
            .send(ClientRequest::TurtleProp(id, TurtleProp::FillColor));
    ...
    pub async fn turtle_is_filling(&self, id: TurtleId) -> bool {
        self.client
            .send(ClientRequest::TurtleProp(id, TurtleProp::IsFilling));
    ...
    pub async fn turtle_position(&self, id: TurtleId) -> Point {
        self.client
            .send(ClientRequest::TurtleProp(id, TurtleProp::Position));
    ...
    pub async fn turtle_heading(&self, id: TurtleId) -> Radians {
        self.client
            .send(ClientRequest::TurtleProp(id, TurtleProp::Heading));
    ...
    pub async fn turtle_speed(&self, id: TurtleId) -> Speed {
        self.client
            .send(ClientRequest::TurtleProp(id, TurtleProp::Speed));
    ...
    pub async fn turtle_is_visible(&self, id: TurtleId) -> bool {
        self.client
            .send(ClientRequest::TurtleProp(id, TurtleProp::IsVisible));
    ...
    pub fn turtle_set_fill_color(&self, id: TurtleId, value: Color) {
        ...
        self.client.send(ClientRequest::SetTurtleProp(
            id,
            TurtlePropValue::FillColor(value),
        ))
    }
    ...
    pub fn turtle_set_is_visible(&self, id: TurtleId, value: bool) {
        self.client.send(ClientRequest::SetTurtleProp(
            id,
            TurtlePropValue::IsVisible(value),
        ))
    }

    pub fn turtle_reset_heading(&self, id: TurtleId) {
        self.client
            .send(ClientRequest::ResetTurtleProp(id, TurtleProp::Heading))
    }
    ...
    pub async fn move_forward(&self, id: TurtleId, distance: Distance) {
        ...
        match response {
            ServerResponse::AnimationComplete(recv_id) => {
                debug_assert_eq!(
                    id, recv_id,
                    "bug: notified of complete animation for incorrect turtle"
                );
            }
            _ => unreachable!(
                "bug: expected to receive `AnimationComplete` in response to `MoveForward` request"
            ),
        }
    }
    ...
    pub async fn move_to(&self, id: TurtleId, target: Point) {
        ...
        match response {
            ...
            _ => unreachable!(
                "bug: expected to receive `AnimationComplete` in response to `MoveTo` request"
            ),
        }
    }
    ...
    pub async fn debug_turtle(&self, id: TurtleId, angle_unit: AngleUnit) -> debug::Turtle {
        ...
        match response {
            ServerResponse::DebugTurtle(recv_id, state) => {
                debug_assert_eq!(
                    id, recv_id,
                    "bug: received debug turtle for incorrect turtle"
                );
                state
            }
            _ => unreachable!(
                "bug: expected to receive `DebugTurtle` in response to `DebugTurtle` request"
            ),
        }
    }
    ...
    pub async fn debug_drawing(&self) -> debug::Drawing {
        ...
        match response {
            ...
            _ => unreachable!(
                "bug: expected to receive `DebugDrawing` in response to `DebugDrawing` request"
            ),
        }
    }
}
